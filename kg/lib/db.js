/**
 * VENDORED + PATCHED from the Multi-knowledgeGraph engine (MIT, © ChenLiangChong).
 * Local patch: setDbPath() resolves a relative --db against process.cwd() (the
 * project root) instead of the engine's __dirname — fixing kg/kg/<name>.db
 * double-nesting on Windows. See THIRD_PARTY_NOTICES.md.
 */
/**
